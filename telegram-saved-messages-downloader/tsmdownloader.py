...
def fEjecutarComandoElevado(aComando):
  ...
  print("[✗] Se necesitan privilegios para instalar dependencias APT y no se encontró sudo.")
  print("[*] Ejecuta el script como root o instala previamente python3-pip.")
  sys.exit(1)
