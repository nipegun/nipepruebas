...
fMain() {
  ...
  echo ""
  echo "============================================="
  echo "  luci-theme-saas-dark v2.0.0 (legacy)"
  echo "  Compatible con OpenWrt 24.10.x e inferiores"
  echo "============================================="
  echo ""

  # Comprobar que curl está disponible
  if ! command -v curl > /dev/null 2>&1; then
    echo "[ERROR] curl no está instalado. Ejecuta: opkg update && opkg install curl" >&2
    return 1
  fi
