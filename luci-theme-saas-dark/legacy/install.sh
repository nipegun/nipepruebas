...
echo "  uci set luci.themes.SaaSDark='/luci-static/saas-dark'"
echo "  uci set luci.main.mediaurlbase='/luci-static/saas-dark'"
echo "  uci commit luci"
echo "  /etc/init.d/uhttpd restart"
echo ""
echo "(Si no ejecutas lo anterior, el UCI defaults lo hará automáticamente en el siguiente reinicio.)"
